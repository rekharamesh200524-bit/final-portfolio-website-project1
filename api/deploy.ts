    ...
    if (data.theme === 'creative') {
          ...
          <div class="max-w-5xl mx-auto relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
              ...
              <div class="md:col-span-2 space-y-8">
                <h2 class="text-3xl font-black mb-8" data-aos="fade-left">Featured Projects</h2>
                <div class="grid grid-cols-1 gap-6">
                  ${data.projects.map((p: any, i: number) => `
                    <a href="${p.link}" class="block p-8 rounded-3xl bg-slate-800/30 border border-slate-700 hover:bg-slate-800/50 transition-all" data-aos="fade-up" data-aos-delay="${i * 100}">
      ...
      themeHtml = `
        <div class="min-h-screen bg-white text-slate-900 font-sans">
          <header class="border-b border-slate-100 py-24 bg-slate-50" data-aos="fade-down">
          ...
          <main class="max-w-4xl mx-auto px-6 py-20 grid grid-cols-1 md:grid-cols-4 gap-16">
            ...
            <div class="md:col-span-3 space-y-16">
              ...
              <section>
                <h2 class="text-2xl font-bold mb-8" data-aos="fade-up">Selected Projects</h2>
          ...
          <div class="max-w-3xl mx-auto">
            ...
            <section>
              ...
              <div class="space-y-16">
                ${data.projects.map((p: any, i: number) => `
                  <div data-aos="fade-in" data-aos-delay="${400 + (i * 100)}">
